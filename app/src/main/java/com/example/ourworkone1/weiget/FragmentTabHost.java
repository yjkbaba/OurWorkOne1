package com.example.ourworkone1.weiget;
...
public class FragmentTabHost extends TabHost implements
    ...
    public void addTab(TabSpec tabSpec, Class<?> clss, Bundle args) {
        ...
        if (mAttached) {
            ...
            // sure this tab's com.example.myworkone3.fragment is inactive if it exists. This shouldn't
            // normally happen.
            info.fragment = mFragmentManager.findFragmentByTag(tag);
            if (info.fragment != null && !info.fragment.isDetached()) {
                FragmentTransaction ft = mFragmentManager.beginTransaction();
//				ft.detach(info.com.example.myworkone3.fragment);
...
//			if (tab.com.example.myworkone3.fragment != null && !tab.com.example.myworkone3.fragment.isDetached()) {
            if (tab.fragment != null) {
                if (tab.tag.equals(currentTab)) {
                    // The com.example.myworkone3.fragment for this tab is already there and
                    // active, and it is what we really want to have
                    // as the current tab. Nothing to do.
                    mLastTab = tab;
                } else {
                    // This com.example.myworkone3.fragment was restored in the active state,
                    // but is not the current tab. Deactivate it.
                    if (ft == null) {
                        ft = mFragmentManager.beginTransaction();
                    }
//					ft.detach(tab.com.example.myworkone3.fragment);
...
//					ft.detach(mLastTab.com.example.myworkone3.fragment);
...
//					ft.attach(newTab.com.example.myworkone3.fragment);
